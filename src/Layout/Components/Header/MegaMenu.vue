<template>
  <div>
    <ul class="header-megamenu nav">
      <li class="nav-item">
        <router-link to="problems">Ваши проблемы</router-link>
      </li>
      <li class="nav-item">
        <router-link to="trainings">Группы</router-link>
      </li>
      <li class="nav-item">
        <router-link to="trainings">Вебинары</router-link>
      </li>
      <li class="nav-item">
        <router-link to="trainings">Видеоуроки</router-link>
      </li>
    </ul>
